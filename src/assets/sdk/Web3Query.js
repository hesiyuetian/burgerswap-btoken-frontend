...
export var Web3Query = {
    initialize() {
        queryContract = new Web3Provider.web3.eth.Contract(QueryABI, Web3Provider.getQueryAddress());
        // window["xxxx"] = queryContract
        window["Web3Query"] = Web3Query
        console.log('Web3Provider.getQueryAddress()', Web3Provider.getQueryAddress());
    },
